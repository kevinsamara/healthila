  ...
  return (
    <main style={{backgroundColor: '#faf7f2', minHeight: '100vh'}}>
      ...
      <div className="detail-container">
        {/* KIRI */}
        <div>
          <div style={{backgroundColor: product.bg, borderRadius: '24px', padding: '3rem', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '10rem', marginBottom: '1rem', boxShadow: '0 4px 20px rgba(0,0,0,0.06)'}}>
            {product.icon}
          </div>
        ...
        <div style={{display: 'flex', flexDirection: 'column', gap: '1.5rem'}}>
          ...
          <p style={{color: '#6b7280', fontSize: '0.8rem', textAlign: 'center'}}>
            Pesan WA akan terisi otomatis dengan detail pesananmu
          </p>
