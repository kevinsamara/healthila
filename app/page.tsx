    ...
    <main>
      <style>{`
        .hero-section {
          ...
          padding: 4rem 6rem; overflow: hidden;
        }
        .hero-image { flex: 1; display: flex; justify-content: center; align-items: center; }
        .hero-circle { width: 400px; height: 400px; background-color: rgba(255,255,255,0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 8rem; }
        .hero-buttons { display: flex; gap: 1rem; flex-wrap: wrap; }
        .btn-wa { background-color: #25D366; color: white; padding: 0.9rem 2rem; border-radius: 999px; text-decoration: none; font-weight: bold; font-size: 1rem; }
        .btn-outline { background-color: transparent; color: white; padding: 0.9rem 2rem; border-radius: 999px; text-decoration: none; font-weight: bold; font-size: 1rem; border: 2px solid white; }
        .categories-section { background-color: white; padding: 3rem 6rem; display: flex; justify-content: center; gap: 3rem; flex-wrap: wrap; box-shadow: 0 4px 20px rgba(0,0,0,0.05); }
        .products-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; max-width: 900px; margin: 0 auto; }
        ...
        @media (max-width: 768px) {
          ...
          .footer-section { padding: 3rem 1.5rem; }
        }
      `}</style>
      ...
      <section className="hero-section">
        <div style={{flex: 1}}>
          ...
          <div className="hero-buttons">
            <a href="https://wa.me/628123456789" target="_blank" rel="noopener noreferrer" className="btn-wa">
          ...
          {products.map((product) => (
            <div key={product.name} style={{backgroundColor: product.bg, borderRadius: '16px', padding: '1.25rem', display: 'flex', alignItems: 'center', gap: '1rem', boxShadow: '0 2px 12px rgba(0,0,0,0.06)'}}>
              ...
              <div style={{flex: 1}}>
                ...
                <a href="https://wa.me/628123456789" target="_blank" rel="noopener noreferrer" style={{backgroundColor: '#1a5c2e', color: 'white', padding: '0.35rem 0.9rem', borderRadius: '999px', textDecoration: 'none', fontSize: '0.78rem', fontWeight: '600'}}>
                  Order via WA
                </a>
              </div>
            </div>
          ...
          {articles.map((art) => (
            <a key={art.title} href="#" style={{textDecoration: 'none', textAlign: 'left'}}>
              <div style={{backgroundColor: '#f0fdf4', borderRadius: '16px', padding: '1.5rem', boxShadow: '0 2px 12px rgba(0,0,0,0.06)'}}>
                ...
                <span style={{backgroundColor: '#1a5c2e', color: 'white', padding: '0.2rem 0.6rem', borderRadius: '999px', fontSize: '0.7rem', fontWeight: '600'}}>{art.tag}</span>
      ...
      {/* FOOTER */}
      <footer style={{backgroundColor: '#0f3d1e', padding: '3rem 6rem', color: 'rgba(255,255,255,0.7)'}} className="footer-section">
